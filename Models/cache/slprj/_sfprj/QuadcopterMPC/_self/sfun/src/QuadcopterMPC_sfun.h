#ifndef __QuadcopterMPC_sfun_h__
#define __QuadcopterMPC_sfun_h__
...
extern mxArray* load_QuadcopterMPC_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_QuadcopterMPC_optimization_info(void);
