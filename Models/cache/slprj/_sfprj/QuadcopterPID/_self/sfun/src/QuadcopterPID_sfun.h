#ifndef __QuadcopterPID_sfun_h__
#define __QuadcopterPID_sfun_h__
...
extern mxArray* load_QuadcopterPID_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_QuadcopterPID_optimization_info(void);
